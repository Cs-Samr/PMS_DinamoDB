...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $subdivisions = [
        ...
        'منطقة Project Manegment System', 'منطقة المدينة المنورة',
    ...
    protected static $governorates = [
        ...
        'Project Manegment System', 'جدة', 'الطائف', 'القنفذة', 'الليث', 'رابغ', 'خليص', 'الخرمة', 'رنية', 'تربة', 'الجموم', 'الكامل', 'المويه', 'ميسان', 'أضم', 'العرضيات', 'بحرة',
